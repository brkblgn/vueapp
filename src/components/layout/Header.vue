<template>
  <header class="navbar navbar-expand-md navbar-dark sticky-top d-print-none">
    <div class="container-xl">
      ...
      >
        <router-link to="/" :class="abc">
          <b>| {{ this.$store.state.ui.navbara_title }} |</b>
        </router-link>
      </h1>
        ...
        <div class="nav-item dropdown">
          ...
          >
            ...
            <div class="d-none d-xl-block ps-2">
              <div>Ersin Feyzioglu</div>
              <div class="mt-1 small text-muted">{{ $t("header.title") }}</div>
            </div>
          </a>
...
export default {
  ...
  computed: {
    component() {
      return this.$store.state.ui.navbara;
    },
  },
  props: ['abc'],
  methods: {
